    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Update Data Produk</h2>
                <p class="section-lead">Isi data-data Produk yang ingin di update pada aplikasi anda</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" value="{{ $products->stocks }}"
                                        class="form-control @error('stocks') is-invalid @enderror" name="stocks">
                                </div>
                            </div>
                            @error('stocks')
                                <div class="invalid-feedback">
